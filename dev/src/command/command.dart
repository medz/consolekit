...
extension on Iterable<CommandArgument> {
  ...
  void printShortHelp(Console console) {
    final message = ConsoleText.fragment();
    for (final argument in this) {
      message.add(ConsoleTextFragment(' <'));
      message.add(ConsoleTextFragment(argument.name, ConsoleStyle.warning));
    ...
    console.output(message, newline: false);
  }
}
...
extension on Iterable<CommandOption> {
  ...
  void printShortHelp(Console console) {
    ...
    for (final option in this) {
      message.add(ConsoleTextFragment(' ['));
      message.add(ConsoleTextFragment(option.name, ConsoleStyle.success));
      if (option.short != null) {
        message.add(
            ConsoleTextFragment(',-${option.short}', ConsoleStyle.success));
      }
      message.add(ConsoleTextFragment('='));
      message.add(ConsoleTextFragment('<value>', ConsoleStyle.warning));
